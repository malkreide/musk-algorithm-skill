...
Der Musk-Algorithmus Skill kann auf verschiedene Arten in Claude integriert werden. Diese Anleitung deckt alle gÃ¤ngigen Szenarien ab.
...
2. **In Claude.ai importieren**
   ...
   - WÃ¤hle **Einstellungen**
   - Navigiere zu **Skills**
   - Klicke auf **+ Skill hinzufÃ¼gen**
   - WÃ¤hle **Von Datei hochladen**
   - WÃ¤hle die heruntergeladene `SKILL.md` Datei
   - Klicke **Speichern**

3. **Skill aktivieren**
   - Der Skill ist jetzt in deiner Skill-Bibliothek
   - Aktiviere ihn global oder nur fÃ¼r bestimmte Projekte

### Verifizierung

Teste den Skill mit:
```
Kannst du mir den Musk-Algorithmus erklÃ¤ren?
```

Claude sollte die 5 Schritte sequenziell erklÃ¤ren.
...
message = client.messages.create(
    ...
    messages=[
        {
            "role": "user", 
            "content": "Analysiere den Prozess fÃ¼r Beschaffungen."
        }
    ]
)
...
async def list_resources() -> list[Resource]:
    return [
        Resource(
            ...
            description="5-Schritte-Prozessanalyse fÃ¼r Ã¶ffentliche Verwaltung"
        )
    ]
...
3. Schreibe: "Verwende die Methodik aus dieser Datei fÃ¼r folgende Analyse: [dein Prozess]"

**Nachteil:** Funktioniert nur fÃ¼r den aktuellen Chat, nicht persistent.
...
- PrÃ¼fe, ob der Skill in den Einstellungen aktiviert ist

### "Skill funktioniert nicht wie erwartet"
- Stelle sicher, dass du die aktuellste Version der `SKILL.md` verwendest
- PrÃ¼fe, ob der Skill-Inhalt vollstÃ¤ndig ist (15 KB GrÃ¶sse)

### API-Integration: "System Prompt zu lang"
- Der Skill ist ca. 15 KB gross â€“ verwende ein Modell mit grossem Context Window (z.B. Claude Sonnet 4)
...
2. **Kombination mit anderen Skills**: Der Musk-Algorithmus lÃ¤sst sich gut kombinieren mit:
   - Dokumenten-Erstellungs-Skills (fÃ¼r Berichte)
   - Datenanalyse-Skills (fÃ¼r Kennzahlen)
...
- Ã–ffne ein [GitHub Issue](https://github.com/[dein-username]/musk-algorithm-skill/issues)
